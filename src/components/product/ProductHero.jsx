...
const ProductHero = () => {
  return (
    <div className="bg-gray-50">
      <div className="h-[180px] md:h-80 flex items-center bg-gray-900 relative">
        <div className="max-w-7xl mx-auto px-6 w-full">
          <h1 className="text-4xl md:text-5xl font text-white mb-4">
            Frames Collection
          </h1>

          <p className="text-gray-300 max-w-xl mb-6 pr-20">
            ...
            wall photo frames — personalised, professionally printed and
